...
export declare interface ApplicationUserListQueryParams
...
export declare class BaseChannel {
  ...
  createMutedUserListQuery(
    params?: MutedUserListQueryParams
  ): MutedUserListQuery;
  createBannedUserListQuery(
    params?: BannedUserListQueryParams
  ): BannedUserListQuery;
  createPreviousMessageListQuery(
    params?: PreviousMessageListQueryParams
...
export declare interface BlockedUserListQueryParams
  extends BaseListQueryParams {
  userIdsFilter?: string[];
}
...
export declare type FailedMessageHandler = (
  err: Error,
  message: SendableMessage
) => void;
...
export declare interface FileMessageCreateParams
  extends BaseMessageCreateParams {
  file?: FileCompat;
  fileKey?: string;
  fileUrl?: string;
  fileName?: string;
...
export declare class MessageCollectionInitHandler {
  onCacheResult(
    handler: MessageCollectionInitResultHandler
...
export declare type MessageCollectionInitResultHandler = (
  err: Error,
  messages: BaseMessage[]
) => void;
...
export declare class MessageModule extends Module {
  ...
  buildMessageFromSerializedData(
    serialized: object
  ): UserMessage | FileMessage | AdminMessage;
...
declare type ModuleNamespaces<
  T extends Module[],
  M extends T[number] = T[number]
> = {
...
export declare type OnlineDetectorListener = (
  callback: () => void
) => (() => void) | undefined;
...
export declare class OpenChannel extends BaseChannel {
  ...
  createParticipantListQuery(
    params: ParticipantListQueryParams
...
export declare interface PollVoterListQueryParams
  extends ChannelDataListQueryParams {
  pollId: number;
  pollOptionId: number;
}
...
export declare interface PreviousMessageListQueryParams
  extends BaseListQueryParams {
  reverse?: boolean;
  messageTypeFilter?: MessageTypeFilter;
  customTypesFilter?: string[];
...
export declare interface ScheduledFileMessageCreateParams
  extends FileMessageCreateParams {
  scheduledAt: number;
}

export declare interface ScheduledFileMessageUpdateParams
  extends BaseMessageUpdateParams {
  scheduledAt?: number;
  file?: FileCompat;
  fileUrl?: string;
  fileName?: string;
...
export declare interface ScheduledUserMessageCreateParams
  extends UserMessageCreateParams {
  scheduledAt: number;
}

export declare interface ScheduledUserMessageUpdateParams
  extends UserMessageUpdateParams {
  scheduledAt?: number;
}
...
export declare interface UserMessageCreateParams
  extends BaseMessageCreateParams {
  message: string;
...
export declare interface UserMessageUpdateParams
  extends BaseMessageUpdateParams {
  message?: string;
  translationTargetLanguages?: string[];
  pollId?: number;
...
export declare class GroupChannelCollection {
  ...
  setGroupChannelCollectionHandler(
    handler: GroupChannelCollectionEventHandler
  ): void;
...
export declare interface GroupChannelListQueryParams
  extends BaseListQueryParams,
...
export declare class GroupChannelModule extends Module {
  ...
  createGroupChannelCollection(
    params?: GroupChannelCollectionParams
  ): GroupChannelCollection;
  createMyGroupChannelListQuery(
    params?: GroupChannelListQueryParams
  ): GroupChannelListQuery;
  createPublicGroupChannelListQuery(
    params?: PublicGroupChannelListQueryParams
  ): PublicGroupChannelListQuery;
  createScheduledMessageListQuery(
    params?: ScheduledMessageListQueryParams
  ...
  buildGroupChannelListQueryFromSerializedData(
    serialized: object
  ): GroupChannelListQuery;
...
export declare interface PublicGroupChannelListQueryParams
  extends BaseListQueryParams {
  includeEmpty?: boolean;
  includeFrozen?: boolean;
  includeMetaData?: boolean;
...
export declare interface ScheduledMessageListQueryParams
  extends BaseListQueryParams {
  channelUrl?: string;
...
export declare interface OpenChannelListQueryParams
  extends BaseListQueryParams {
  includeFrozen?: boolean;
  includeMetaData?: boolean;
  nameKeyword?: string;
...
export declare class OpenChannelModule extends Module {
  ...
  createOpenChannelListQuery(
    params?: OpenChannelListQueryParams
